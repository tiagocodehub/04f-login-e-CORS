    ...
    public class ExoContext : DbContext
    {
        ...
        optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Server = localhost\\SQLWORK; Database = ExoApi; Trusted_Connection = True;");
                ...
                //"Server=localhost\\SQLWORK;"+ "Database=ExoApi;Trusted_Connection=True;"
            }
        }
